# JC2_miniRECgap.R — Run script for miniRECgap NEE/Reco/GPP gap-filling
#
...
MODEL_CHOICE <- "miniRECgap"   # "MDS" or "miniRECgap"; names the model script and results subfolder
