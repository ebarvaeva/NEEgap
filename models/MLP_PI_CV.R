# =============================================================================
# MLP_PI_CV.R — MLP: BASE + Phytomass Index (Grazing not in predictors)
# =============================================================================
#
# PURPOSE
...
#
#     PI_ENABLED <- TRUE   # Hardcoded for this ablation variant
#
#   is hardcoded, activating the Phytomass Index regardless of the
#   predictor list.  Grazing_days_since is NOT in predictors; PI is the sole management signal.
#
