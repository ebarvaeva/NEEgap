# =============================================================================
# XGBoost_PI_CV.R — XGBoost: BASE + Phytomass Index (Grazing not in predictors)
# =============================================================================
#
# PURPOSE
#   Variant of XGBoost_CV.R for the management variable ablation study.
#   Identical in all respects to XGBoost_CV.R except that:
#
#     PI_ENABLED <- TRUE
#
#   is hardcoded, activating the Phytomass Index regardless of the
#   predictor list.  See XGBoost_CV.R for full section documentation.
#
# OUTPUTS  (written to RESULTS_DIR)
#   df_cv_all_predictions.rds, boosting_evaluation_curves/,
...
# =============================================================================
# SECTION 7 — XGBoost boosting curve saver
# =============================================================================
...
# =============================================================================
# SECTION 8 — XGBoost cross-validation  (NEE only)
# =============================================================================
