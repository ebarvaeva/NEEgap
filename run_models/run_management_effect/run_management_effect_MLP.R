# run_management_effect_MLP.R — MLP feature-addition batch runner
# Trains the MLP once per management variable, each time on the BASE predictor
...
# every site in SITES and every variable in MGMT_VARS, sourcing models/MLP_CV.R
# in an isolated environment for each combination.
