# JC1_2023_qc.R — quality-control the half-hourly CO2 flux for JC1 2023
#
...
#
# Input  : data/raw_data/JC1_2023_{eddypro,biomet,meta,fluxnet}.xlsx
...
# Output : data/data_qc/results_qc_JC1_2023/merged_qc.csv
#          data/data_qc/results_qc_JC1_2023/merged_qc.rds
#          data/data_qc/results_qc_JC1_2023/ustar_seasonal_thresholds.rds
#----------------------------------------------------------
# Packages
library(here)
library(readr)
...
eddypro_path <- here::here("data/raw_data/JC1_2023_eddypro.xlsx")
meta_path    <- here::here("data/raw_data/JC1_2023_meta.xlsx")
fluxnet_path <- here::here("data/raw_data/JC1_2023_fluxnet.xlsx")
biomet_path  <- here::here("data/raw_data/JC1_2023_biomet.xlsx")
